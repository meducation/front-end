(function() {
  var mainModule, medVoterFunction, mediaFileUploadControllerFunction, syllabusItemsControllerFunction, syllabusItemsServiceFunction, votesServiceFunction;
  ...
  mediaFileUploadControllerFunction = function($scope) {
    $scope.isFormSubmissionDisabled = true;
    $scope.init = function(externalServerUrl) {
      return $scope.externalServerUrl = externalServerUrl;
    };
    $scope.options = {
      dataType: 'xml',
      autoUpload: true
