(function() {
  ...
  medVoterFunction = function($compile, $templateCache) {
    var determineElementIDToUse, determineFixedPositioning, determineNegativeClass, determineTemplateToUse, loadTemplateFromCacheAndCompile, setRating, setVotedState;
