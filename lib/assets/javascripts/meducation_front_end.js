(function() {
  var mainModule, medVoterFunction, syllabusItemsControllerFunction, syllabusItemsServiceFunction, votesServiceFunction;
  ...
  syllabusItemsControllerFunction = function($scope, syllabusItemsService) {
    ...
    return $scope.showSelect = function(level) {
      if (level) {
        return level.children.length > 0;
      }
    };
  };
