(function() {
  var mainModule, medFacebookPromptFunction, medVoterFunction, votesServiceFunction;

  angular.module('meducationTemplates', ['/assets/commentVote.html', '/assets/facebookPrompt.html', '/assets/pageVote.html']);
  ...
  medFacebookPromptFunction = function($compile, $templateCache) {
    ...
    return {
      ...
      link: function(scope, element) {
        return loadTemplateFromCacheAndCompile(element, '/assets/facebookPrompt.html', scope);
      },
