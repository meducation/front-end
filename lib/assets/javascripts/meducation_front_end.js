(function() {
  ...
  mainModule.directive('medVoter', function($compile, $templateCache) {
    var checkAndApplyNegativeClass;
    checkAndApplyNegativeClass = function(scope, rating) {
    ...
    return {
      ...
      link: function(scope, element) {
        ...
        scope.ratingText = scope.rating >= 0 ? "+" + scope.rating : "" + scope.rating;
        scope.votedUp = scope.liked;
        scope.votedDown = scope.liked != null ? !scope.liked : void 0;
        return checkAndApplyNegativeClass(scope, scope.rating);
      },
